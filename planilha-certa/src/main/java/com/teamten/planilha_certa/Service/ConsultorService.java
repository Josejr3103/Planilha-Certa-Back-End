...
@Service
public class ConsultorService {@Autowired
private Firestore firestore;
    ...
    private void initializeIdCounter() {
        try {
            ...
            for (QueryDocumentSnapshot document : documents) {
                Consultor projetos = document.toObject(Consultor.class);
                maxId = Math.max(maxId, projetos.getIdConsultor());
            }
    ...
    public Consultor cadastrarConsultorEspeciGestao(ConsultorEspeciGestao Consultor) {
        long newId = idCounter.incrementAndGet();
        Consultor.setIdConsultor(newId);
    ...
    public Consultor cadastrarConsultorEsspeciTI(ConsultorEspeciTI Consultor) {
        long newId = idCounter.incrementAndGet();
        Consultor.setIdConsultor(newId);
    ...
    public boolean editarConsultor(Consultor Consultor) {
        ...
        ApiFuture<WriteResult> future = projetos.document(String.valueOf(Consultor.getIdConsultor())).set(Consultor);
